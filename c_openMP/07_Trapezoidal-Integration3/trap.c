...
now we use a reduction clause to combine the final results
...
int main(int argc, char* argv[])
{
    ...
    {
        // Because 'result' is a reduction variable, OpenMP will
        // implicitly create a private variable for each thread
        // and then the private variables are combined (i.e. reduced)
